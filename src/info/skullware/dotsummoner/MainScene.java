...
public class MainScene extends Scene {
	...
	/**
	 * Sceneを管理するActivityのインスタンスを保持. アプリの場合のContextと同じように利用できる。
	 */
	...
	public void init() {
		...
		BitmapTextureAtlas bta = new BitmapTextureAtlas(mBaseGameActivity.getTextureManager(), 512, 1024,
		...
		ITextureRegion btr = BitmapTextureAtlasTextureRegionFactory.createFromAsset(bta, mBaseGameActivity,
				"main_bg.png", 0, 0);
